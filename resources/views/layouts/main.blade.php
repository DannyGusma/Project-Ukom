...
<body>
    ...
    <h1 style="font-size: 20px; font-family: cursive; margin-left:500px; " id="jam"></h1>
</center>
</body>
</html>
                    ...
                    <li class="transition group">
                        <button type="button" class="flex items-center p-2 w-full text-base font-normal rounded-lg hover:bg-base-200 dropdown-btn" >
                            ...
                            <ul class="py-2 space-y-2 dropdown-container">
                                <li>
                                    <a href="/pengajuan/barangbaru" class="flex items p-2 pl-11 w-full text-base font-normal rounded -lg transition duration-75 group hover:bg-bsae-200">Pengajuan BB</a>
                                </li>
                                <li>
